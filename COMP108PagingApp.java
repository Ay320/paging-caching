...
class COMP108PagingApp {
	...
	private static final int EvictLFD = 2;
	...
	public static void main(String[] args) throws Exception {
		...
		if (algorithmChoice == AllAlg || algorithmChoice == EvictLFD) {

			try {
				System.out.println();
				System.out.println("evictLFD");
				copyArray(orgCache, cache, cacheSize);
				output = COMP108Paging.evictLFD(cache, cacheSize, request, requestSize);
				output.print(outputChoice);
			}
			catch (Exception e) {
